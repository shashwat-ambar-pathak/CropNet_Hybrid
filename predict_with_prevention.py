...
if __name__ == "__main__":
    test_img = "ora.jpg"   # Change this to your test image
    disease, conf, tips, top_preds = predict_disease(test_img)
    ...
    plt.title(f"Prediction: {disease} ({conf:.2f}%)\n{tips_text}", fontsize=10)
    plt.show()

    # Print results
    print(f"\n✅ Primary Prediction: {disease} ({conf:.2f}%)")
